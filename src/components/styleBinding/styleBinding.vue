<script setup>
const bgOrange = 'background-color: rgba(251, 146, 60, 1); color: red'
const bgIndigo = 'background-color: rgba(129, 140, 248, 1) ; color: orange'
const bgGreen = 'background-color: rgba(52, 211, 153, 1); color: green'
...
<template>
  <section class="container mx-auto">
    ...
    <section class="flex space-x-10">
      <div class="w-1/3 h-16" :style="bgOrange">x</div>
      <div class="w-1/3 h-16" :style="bgIndigo">x</div>
      <div class="w-1/3 h-16" :style="bgGreen">x</div>
    </section>
