      ...
      <div class="w-10/12 mx-auto rounded border">
        <div class="bg-white p-10 shadow-sm">
          ...
          <div class="transition hover:bg-indigo-50">
            ...
            <!-- Content -->
            <div class="px-5 pt-0 text-left pb-5" v-show="accordionIndex == 1">
          ...
          <div class="transition hover:bg-indigo-50">
            ...
            <div
              class="accordion-header cursor-pointer transition flex space-x-5 px-5 items-center h-16"
              @click="accordionIndex = 4"
            >
              <i class="fas fa-plus"></i>
              <h3>Chamber reached do he nothing be?</h3>
            </div>
            <!-- Content -->
            <div class="accordion-content px-5 pt-0 text-left pb-5" v-show="accordionIndex == 4">
              <p class="leading-6 font-light pl-9">
